...
export function ListeMariageV2({ showCagnotte = true }: { showCagnotte?: boolean }) {
  ...
  return (
    <section
      ...
      role="region"
      aria-label={showCagnotte ? LISTE_MARIAGE.title : COUPLE.merciTitle}
    >
      {showCagnotte && (
        <>
      ...
      {/* Clôture — gratitude */}
      <div className={`${showCagnotte ? 'mt-16 ' : ''}flex flex-col items-center text-center`}>
