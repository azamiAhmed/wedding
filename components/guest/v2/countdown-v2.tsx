...
function Cell({ value, label }: { value: number; label: string }) {
  ...
  return (
    <div className="scroll-reveal flex flex-col items-center">
      <div className="relative flex items-center justify-center min-w-[68px] sm:min-w-[88px] aspect-square rounded-md border border-gold-moroccan/40 bg-white-broken/70 backdrop-blur-sm shadow-[0_4px_20px_-12px_rgba(58,36,52,0.25)]">
        <span
          className="font-display text-3xl sm:text-5xl text-brown-deep tabular-nums"
      ...
      <span className="mt-3 font-sans text-[10px] sm:text-xs tracking-[0.3em] uppercase text-brown-medium">
        {label}
      </span>
    </div>
  )
  ...
  return (
    ...
    >
      ...
      <div className="mt-10 flex items-center justify-center gap-3 sm:gap-5">
        ...
        <span className="font-display text-3xl text-gold-moroccan/60 hidden sm:inline">·</span>
